      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center lg:justify-end gap-4 md:gap-5">
            ...
            <a href="https://github.com/nopaiseh/bingetrack.ing" target="_blank" rel="noreferrer" className="text-white/50 hover:text-white hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)] transition-all duration-300" aria-label="在GitHub上查看源码">
