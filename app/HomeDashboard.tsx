      ...
      <div className="flex flex-col gap-6 md:gap-8 mb-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-white/5 pb-5">
          ...
          <div className="flex gap-1 bg-[#121212] p-1.5 rounded-xl border border-white/10 shadow-inner">
            {tabs.map((tab) => (
              <button key={tab} onClick={() => setActiveTab(tab)} className={`px-5 py-2 rounded-lg text-sm font-medium transition-all duration-300 ${activeTab === tab ? "bg-white/10 text-white shadow-sm ring-1 ring-white/5" : "text-neutral-400 hover:text-white hover:bg-white/5"}`}>
                {tab}
              </button>
            ))}
          </div>
          ...
          <div className="relative" ref={dropdownRef}>
            <div onClick={() => setIsDropdownOpen(true)} className="flex items-center gap-2 bg-[#121212] border border-white/10 hover:border-white/20 transition-all pl-4 pr-3 py-2.5 rounded-xl cursor-text w-35 group">
              ...
              <i className={`fas fa-chevron-down text-xs text-neutral-500 transition-transform duration-300 ${isDropdownOpen ? "rotate-180" : ""}`}/>
            </div>
          ...
          <div key="overview" className="animate-fade-in flex flex-col gap-4 md:gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col justify-between transition-all duration-300 hover:-translate-y-1 hover:bg-white/10 hover:border-white/20 hover:shadow-xl hover:shadow-black/50 group">
                ...
                <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden mt-2">
                  <div className="h-full bg-linear-to-r from-red-600 to-red-400 shadow-[0_0_12px_rgba(239,68,68,0.4)] rounded-full" style={{ width: `${Math.round(((currentYearData?.total_watched_runtime ?? 0) / (currentYearData?.total_runtime ?? 0)) * 100)}%` }}/>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col gap-6 transition-all duration-300 hover:-translate-y-1 hover:bg-white/10 hover:border-white/20 hover:shadow-xl hover:shadow-black/50 group">
              ...
              <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden">
                <div className="h-full bg-linear-to-r from-red-600 to-red-400 shadow-[0_0_12px_rgba(239,68,68,0.4)] rounded-full" style={{ width: `${moviesPercent}%` }}/>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6">
              ...
              <div className="col-span-1 md:col-span-3 bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col justify-center transition-all duration-300 hover:-translate-y-1 hover:bg-white/10 hover:border-white/20 hover:shadow-xl hover:shadow-black/50 group">
                ...
                <div>
                  ...
                  <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden">
                    <div className="h-full bg-linear-to-r from-red-600 to-red-400 shadow-[0_0_12px_rgba(239,68,68,0.4)] rounded-full" style={{ width: `${moviesPercent}%`, transition: "width 1s cubic-bezier(0.4, 0, 0.2, 1)" }}/>
                  </div>
                </div>
              </div>
              ...
              <div className="col-span-1 md:col-span-1 bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col justify-center transition-all duration-300 hover:-translate-y-1 hover:bg-white/10 hover:border-white/20 hover:shadow-xl hover:shadow-black/50 group">
                ...
                <div>
                  ...
                  <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden">
                    <div className="h-full bg-linear-to-r from-red-600 to-red-400 shadow-[0_0_12px_rgba(239,68,68,0.4)] rounded-full" style={{ width: `${avgMoviesRatingPercent}%`, transition: "width 1s cubic-bezier(0.4, 0, 0.2, 1)" }}/>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div key="tv-series" className="animate-fade-in flex flex-col gap-4 md:gap-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6">
              ...
              <div className="col-span-1 md:col-span-3 bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col justify-center transition-all duration-300 hover:-translate-y-1 hover:bg-white/10 hover:border-white/20 hover:shadow-xl hover:shadow-black/50 group">
                ...
                <div>
                  ...
                  <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden">
                    <div className="h-full bg-linear-to-r from-red-600 to-red-400 shadow-[0_0_12px_rgba(239,68,68,0.4)] rounded-full" style={{ width: `${seriesPercent}%`, transition: "width 1s cubic-bezier(0.4, 0, 0.2, 1)" }}/>
                  </div>
                </div>
              </div>
              ...
              <div className="col-span-1 md:col-span-1 bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col justify-center transition-all duration-300 hover:-translate-y-1 hover:bg-white/10 hover:border-white/20 hover:shadow-xl hover:shadow-black/50 group">
                ...
                <div>
                  ...
                  <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden">
                    <div className="h-full bg-linear-to-r from-red-600 to-red-400 shadow-[0_0_12px_rgba(239,68,68,0.4)] rounded-full" style={{ width: `${avgSeriesRatingPercent}%`, transition: "width 1s cubic-bezier(0.4, 0, 0.2, 1)" }}/>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-12 mt-4">
              ...
              {isLoadingMedia ? (
                ...
                <MediaRow title="影史精选" items={topSeries} viewAllLink={`/series/watched?year=${selectedYear}`} type="series"/>
              )}
            </div>
          </div>
        )}
