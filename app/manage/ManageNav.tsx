...
import { Film, Tv, Layers, ListVideo, Users, Library, Tags, Globe, Settings, ArrowUpRight } from "lucide-react";

const groups = [
  { label: "影视内容", items: [
    { label: "电影", value: "movie", icon: Film }, { label: "电视剧", value: "tv_series", icon: Tv },
    { label: "剧季", value: "tv_season", icon: Layers }, { label: "剧集", value: "tv_episode", icon: ListVideo },
  ] },
  { label: "关联资料", items: [
    { label: "人物", value: "people", icon: Users }, { label: "系列", value: "collections", icon: Library },
    { label: "类型", value: "genres", icon: Tags }, { label: "地区", value: "regions", icon: Globe },
  ] },
];
