...
export default async function MoviesPage() {
  ...
  const watchedRes = await fetchMediaListServer({ type: 'movie', limit: 10, offset: 0, sort: 'date_desc' });
  const wantRes = await fetchMediaListServer({ type: 'movie', limit: 10, offset: 0, sort: 'date_desc' });
